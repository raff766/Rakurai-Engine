...
PipelineConfigInfo::PipelineConfigInfo(const PipelineConfigInfo& other) 
    : viewport(other.viewport), scissor(other.scissor), viewportInfo(other.viewportInfo), 
    inputAssemblyInfo(other.inputAssemblyInfo), rasterizationInfo(other.rasterizationInfo),
    multisampleInfo(other.multisampleInfo), colorBlendAttachment(other.colorBlendAttachment),
    colorBlendInfo(other.colorBlendInfo), depthStencilInfo(other.depthStencilInfo),
    pipelineLayout(other.pipelineLayout), renderPass(other.renderPass), subpass(other.subpass) {
...
PipelineConfigInfo GraphicsPipeline::getDefaultPipelineConfigInfo(uint32_t width, uint32_t height) {
